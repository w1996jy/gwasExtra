...
# Define the UI for the data merge module
data_merge_ui <- function(id) {
  ns <- NS(id)  # Create a namespace

  fluidPage(
    titlePanel("Dataset Join"),
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        downloadButton(ns("download_data"), "Download Merged Data")  # Download button
      ),
...
# Define the server logic for the data merge module
